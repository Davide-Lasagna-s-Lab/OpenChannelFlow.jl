...
function LinearAlgebra.mul!(a::ProjectedField{F, Complex{T}}, A::FarazmandWeight{T}) where {S, F<:FTField{<:ChannelGrid{S}}, T}
...
function LinearAlgebra.dot(a::ProjectedField{F, Complex{T}}, A::FarazmandWeight{T}, b::ProjectedField{F, Complex{T}}) where {S, F<:FTField{<:ChannelGrid{S}}, T}
    sum = zero(T)
